...
class Pizza(ABC):
    ...
    def prepare(self) -> None:
        """Template method"""
        self.hook_before_add_ingrentients()
        self.add_ingrentients()  # Abstract
        self.hook_after_add_ingrentients()
        self.hook_before_cook()
        self.cook()  # Abstract
        self.hook_after_cook()
        self.cut()
        self.serve()

    def hook_before_add_ingrentients(self) -> None:
        pass

    def hook_after_add_ingrentients(self) -> None:
        pass

    def hook_before_cook(self) -> None:
        pass
...
class AModa(Pizza):
    def add_ingrentients(self) -> None:
        print(f"AModa - adicionando ingradientes: presunto, queijo, goiabada.")

    def cook(self) -> None:
        print("AModa - cozinhado por 45 min no forno a lenha.")


class Veg(Pizza):
    def hook_before_add_ingrentients(self) -> None:
        print("Veg - Lavando os ingredientes.")

    def add_ingrentients(self) -> None:
        print(f"Veg - adicionando ingradientes: ingredientes veganos.")

    def cook(self) -> None:
        print("Veg - cozinhado por 45 min no forno a lenha.")
