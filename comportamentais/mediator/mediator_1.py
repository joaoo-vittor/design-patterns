...
if __name__ == "__main__":
    ...
    caetano = Person("Caetano", chat)
    chico = Person("Chico", chat)
    ...
    chico.broadcast("Eu não fui adicionado no chat...")

    print()

    joao.send_direct("Caetano", "Fala meu chapa.")
    caetano.send_direct("Joao", "Opaaaaa!!!")
